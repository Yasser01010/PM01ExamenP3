...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        des_medicamento = (EditText) findViewById(R.id.txtdes_medicina);
        cantidad = (EditText) findViewById(R.id.txtcantidad_medicina);
        periocidad = (EditText) findViewById(R.id.txtperiocidad_medicina);
        img_medicina = (ImageView) findViewById(R.id.img_medicina);
        tiempo = (Spinner) findViewById(R.id.spinner_tiempo);
        camara = (Button) findViewById(R.id.btnfoto_medicina);
...
*/
    ...
    private void ClearScreen() {
        ...
        des_medicamento.setText("");
        cantidad.setText("");
        tiempo.setSelection(0);
        periocidad.setText("");
        img_medicina.setImageBitmap(null);
    }
